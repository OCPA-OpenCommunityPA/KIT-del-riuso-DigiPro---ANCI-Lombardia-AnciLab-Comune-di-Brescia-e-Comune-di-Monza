...
<div class="container">
      <form action='complete' method='POST' enctype='multipart/form-data'>
            ...
            <h2>Verifica amministrativa - approvazione documenti pareri interni</h2>
            ...
            <div class="row">
                  ...
                  <fieldset class="well the-fieldset" style="background:none">
                        ...
                        <div class='panel'>
                              <p><strong>${documentoProtocollato.DOCNAME}
                                          ...
                                          href='/AppBPM/bridge?TYPE=documento&action=download&DOCNUM=${documentoProtocollato.DOCNUM}'>
                                    ...
                                    <span class='small'>Tipologia: ${documentoProtocollato.TYPE_ID}
                                          ...
                                          Numero protocollo: ${documentoProtocollato.NUM_PG} - Anno protocollo:
                                          ${documentoProtocollato.ANNO_PG}
                                          <!--</#if> -->
                                    </span> </p>
                        </div>
                        ...
                        <div class='panel' id="${documento.DOCNUM}">
                              <p><strong>${documento.DOCNAME}</strong>
                                    <a class='btn btn-primary pull-right'
                                          href='/AppBPM/bridge?TYPE=documento&action=download&DOCNUM=${documento.DOCNUM}'>
                  ...
                  <fieldset class="well the-fieldset" style="background:none">
                        ...
                        <div class='panel'>
                              <p><strong>${doc_comunicazioneAvvio.DOCNAME}
                                          ...
                                          href='/AppBPM/bridge?TYPE=documento&action=download&DOCNUM=${doc_comunicazioneAvvio.DOCNUM}'>
                                          <i class='glyphicon glyphicon-download'></i> Scarica</a><br>
                                    <span class='small'>Tipologia: ${doc_comunicazioneAvvio.TYPE_ID}
                                          <!--<#if doc_comunicazioneAvvio.NUM_PG?has_content>-->
                                          Numero protocollo: ${doc_comunicazioneAvvio.NUM_PG} - Anno protocollo:
                                          ${doc_comunicazioneAvvio.ANNO_PG}
                                          <!--</#if>-->
                                    </span> </p>
                        </div>
                  ...
                  <fieldset class="well the-fieldset" style="background:none">
                        ...
                        <div class='panel'>
                              <p><strong>${doc_richiestaIntegrazioni.DOCNAME}
                                          ...
                                          href='/AppBPM/bridge?TYPE=documento&action=download&DOCNUM=${doc_richiestaIntegrazioni.DOCNUM}'>
                                          <i class='glyphicon glyphicon-download'></i> Scarica</a><br>
                                    <span class='small'>Tipologia: ${doc_richiestaIntegrazioni.TYPE_ID}

                                          <!--<#if doc_richiestaIntegrazioni.NUM_PG?has_content>-->
                                          Numero protocollo: ${doc_richiestaIntegrazioni.NUM_PG} - Anno protocollo:
                                          ${doc_richiestaIntegrazioni.ANNO_PG}
                                          <!--</#if>-->
                  ...
                  <fieldset class="well the-fieldset" style="background:none">
                        ...
                        <div class='panel'>
                              <p><strong>${doc_richiestaIntegrazioniRicevuto.DOCNAME}
                                          ...
                                          href='/AppBPM/bridge?TYPE=documento&action=download&DOCNUM=${doc_richiestaIntegrazioniRicevuto.DOCNUM}'>
                                          <i class='glyphicon glyphicon-download'></i> Scarica</a><br>
                                    <span class='small'>Tipologia: ${doc_richiestaIntegrazioniRicevuto.TYPE_ID}
                                          ...
                                          Numero protocollo: ${doc_richiestaIntegrazioniRicevuto.NUM_PG} - Anno
                                          protocollo: ${doc_richiestaIntegrazioniRicevuto.ANNO_PG}
                                          <!--</#if>-->
                  ...
                  <fieldset class="well the-fieldset" style="background:none">
                        ...
                        <div class='panel'>
                              <p><strong>${doc_motiviOstativi.DOCNAME}
                                          ...
                                          href='/AppBPM/bridge?TYPE=documento&action=download&DOCNUM=${doc_motiviOstativi.DOCNUM}'>
                                          <i class='glyphicon glyphicon-download'></i> Scarica</a><br>
                                    <span class='small'>Tipologia: ${doc_motiviOstativi.TYPE_ID}
                                          <!--<#if doc_motiviOstativi.NUM_PG?has_content>-->
                                          Numero protocollo: ${doc_motiviOstativi.NUM_PG} - Anno protocollo:
                                          ${doc_motiviOstativi.ANNO_PG}
                                          <!--</#if>-->
                                    </span> </p>
                        </div>
                  ...
                  <fieldset class="well the-fieldset" style="background:none">
                        ...
                        <div class='panel'>
                              <p><strong>${doc_motiviOstativiRicevuto.DOCNAME}
                                          ...
                                          href='/AppBPM/bridge?TYPE=documento&action=download&DOCNUM=${doc_motiviOstativiRicevuto.DOCNUM}'>
                                          <i class='glyphicon glyphicon-download'></i> Scarica</a><br>
                                    <span class='small'>Tipologia: ${doc_motiviOstativiRicevuto.TYPE_ID}
                                          ...
                                          Numero protocollo: ${doc_motiviOstativiRicevuto.NUM_PG} - Anno protocollo:
                                          ${doc_motiviOstativiRicevuto.ANNO_PG}
                                          <!--</#if>-->
                                    </span> </p>
                        </div>
                  ...
                  <fieldset class="well the-fieldset" style="background:none">
                        ...
                        <div class='panel'>
                              <p><strong>${doc_pareri_interniProtocollato.DOCNAME}
                                          ...
                                          href='/AppBPM/bridge?TYPE=documento&action=download&DOCNUM=${doc_pareri_interniProtocollato.DOCNUM}'>
                                          <i class='glyphicon glyphicon-download'></i> Scarica</a><br>
                                    <span class='small'>Tipologia: ${doc_pareri_interniProtocollato.TYPE_ID}
                                          <!--<#if doc_pareri_interniProtocollato.NUM_PG?has_content>-->
                                          Numero protocollo: ${doc_pareri_interniProtocollato.NUM_PG} - Anno protocollo:
                                          ${doc_pareri_interniProtocollato.ANNO_PG}
                                          <!--</#if>-->
                                    </span> </p>
                        </div>
                  ...
                  <fieldset class="well the-fieldset" style="background:none">
                        <legend class="the-legend">Documento pareri interni Ricevuti da ${parereintRic.descrizione_uo}</legend>
                        <h5><strong>Documento</strong></h5>
                        <div class='panel'>
                              <p><strong>${parereintRic.documento_principale.DOCNAME}
                                    </strong> <a class='btn btn-primary pull-right'
                                          href='/AppBPM/bridge?TYPE=documento&action=download&DOCNUM=${parereintRic.documento_principale.DOCNUM}'>
                                          <i class='glyphicon glyphicon-download'></i> Scarica</a><br>
            ...
            <div class='row'>
                  <fieldset class="well the-fieldset" style="background:none">
                        <legend class="the-legend">Esito approvazione</legend>

                        <div>
                              <p>
                                    <input type="radio" name="approvazionePareriInterni" value="positivo" checked>
                                    Positivo</p>
                              <p><input type="radio" name="approvazionePareriInterni" value="negativo"> Negativo
                              </p>
                        </div>
                  </fieldset>
            </div>
            ...
            <div class='row'>
                  <hr>
                  <div class="alert alert-info">NOTA: inserire note di approvazione!</div>
                  <div class="col-sm-4">
                        <label>Note approvazione </label>
                  </div>
                  <div class="col-sm-4">
                        <p> <textarea name='note_approvazione' class='form-control input-small'></textarea></p>
                  </div>
